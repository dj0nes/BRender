...
static void GEOMETRY_CALL V1Faces_ScratchAllocate(br_geometry *self, br_renderer *renderer)
{
    char     *sp;
    ...
    if(renderer->state.hidden.type == BRT_BUCKET_SORT &&
       (renderer->state.hidden.divert == BRT_ALL || renderer->state.hidden.divert == BRT_BLENDED && rend.block->flags & BR_PRIMF_BLENDED))
 ...
 */
static void GEOMETRY_CALL V1Face_CullNone(br_geometry *self, br_renderer *renderer)
{
    int f;
...
static void GEOMETRY_CALL V1Face_OS_CullNone(br_geometry *self, br_renderer *renderer)
{
    int               f;
    struct temp_face *tfp = rend.temp_faces;
...
static void GEOMETRY_CALL V1Face_CullOneSidedPerspective(br_geometry *self, br_renderer *renderer)
{
    int f, n;
    br_uint_16(*fp_vertices)[3] = rend.face_vertices;
...
static void GEOMETRY_CALL V1Face_CullOneSidedParallel(br_geometry *self, br_renderer *renderer)
{
    int f, n;
    br_uint_16(*fp_vertices)[3] = rend.face_vertices;
    br_vector4       *fp_eqn    = rend.face_eqn;
...
static void GEOMETRY_CALL V1Face_CullTwoSidedPerspective(br_geometry *self, br_renderer *renderer)
{
    int f, df;
    br_uint_16(*fp_vertices)[3] = rend.face_vertices;
    br_vector4       *fp_eqn    = rend.face_eqn;
...
static void GEOMETRY_CALL V1Face_CullTwoSidedParallel(br_geometry *self, br_renderer *renderer)
{
    int f, df;
    br_uint_16(*fp_vertices)[3] = rend.face_vertices;
    br_vector4       *fp_eqn    = rend.face_eqn;
...
static void GEOMETRY_CALL V1Face_CullOneSided(br_geometry *self, br_renderer *renderer)
{
...
static void GEOMETRY_CALL V1Face_OS_CullOneSided(br_geometry *self, br_renderer *renderer)
{
    switch(renderer->state.matrix.view_to_screen_hint) {
        case BRT_PERSPECTIVE:
...
static void GEOMETRY_CALL V1Face_CullTwoSided(br_geometry *self, br_renderer *renderer)
{
    switch(renderer->state.matrix.view_to_screen_hint) {
        case BRT_PERSPECTIVE:
...
static void GEOMETRY_CALL V1Face_OS_CullTwoSided(br_geometry *self, br_renderer *renderer)
{
    switch(renderer->state.matrix.view_to_screen_hint) {
        case BRT_PERSPECTIVE:
 ...
 */
static void GEOMETRY_CALL V1Face_Outcode(br_geometry *self, br_renderer *renderer)
{
    int f;
    br_uint_16(*fp_vertices)[3] = rend.face_vertices;
    struct temp_face *tfp       = rend.temp_faces;
...
static void GEOMETRY_CALL V1Face_Render(br_geometry *self, br_renderer *renderer)
{
    br_uint_16(*fp_vertices)[3] = rend.face_vertices;
...
void GEOMETRY_CALL V1Face_OS_Render(br_geometry *self, struct br_renderer *renderer)
{
    br_uint_16(*fp_vertices)[3] = rend.face_vertices;
    br_uint_16(*fp_edges)[3]    = rend.face_edges;
    br_vector4       *fp_eqn    = rend.face_eqn;
...
void GEOMETRY_CALL V1Face_OSV_Render(br_geometry *self, struct br_renderer *renderer)
{
    br_uint_16(*fp_vertices)[3] = rend.face_vertices;
    br_uint_16(*fp_edges)[3]    = rend.face_edges;
    br_vector4       *fp_eqn    = rend.face_eqn;
 ...
 */
static void GEOMETRY_CALL V1Faces_GeometryFnsCull(br_renderer *renderer)
{
...
static void GEOMETRY_CALL AddReplicateConstant(br_geometry *self, br_renderer *renderer)
{
 ...
 */
static void GEOMETRY_CALL V1Faces_GeometryFnsUpdate(br_geometry *self, br_renderer *renderer, br_boolean divert)
{
    /*
     ...
     */
    if((renderer->state.surface.mapping_source == BRT_ENVIRONMENT_INFINITE) || (renderer->state.surface.mapping_source == BRT_ENVIRONMENT_LOCAL))
...
static br_error V1Model_Render(br_geometry *self, br_renderer *renderer, struct v11model *model, br_renderer_state_stored *default_state,
                               br_token type, br_boolean on_screen)
{
    int                       i, g;
    br_renderer_state_stored *state;
    br_error                  r;
    ...
    for(g = 0; g < model->ngroups; g++) {
        ...
        r = PrimitiveStateRenderBegin(renderer->state.pstate, &rend.block, &rend.block_changed, &rend.range_changed, z_sort, type);
